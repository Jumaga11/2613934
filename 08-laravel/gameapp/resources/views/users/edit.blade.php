...
<section class="scroll">
    <form method="POST" action="{{ url('users/'.$user->id) }}" enctype="multipart/form-data">
        ...
        <div>
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $phone->phone)"
        ...
        <div>
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $email->email)"
        ...
        <button type="submit" class="btn-add">
            <img src="{{ asset('images/tittles/edit.png')}}" alt="btn-register">
        </button>
    </form>
</section>
@endsection
